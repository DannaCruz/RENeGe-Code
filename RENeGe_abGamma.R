####################################
#### 
#Code for the renege model with prior distribution Gamma and b for variance
##############################################
poisson.mtvSIGMab <-
  function(formula,  beta=NULL, phi=NULL, tau2=NULL, rho=NULL, W, Ar, burnin, n.sample, blocksize.beta=5, blocksize.phi=10, prior.mean.beta=NULL, prior.var.beta=NULL, prior.max.tau2=NULL, a_prior_invGamma, b_prior_invGamma)
  {
    ##############################################
    ...
    for(j in 1:n.sample)
    {
      ...
      tau2 <- rinvgamma(n=1, shape=(0.5*n-1)+a_prior_invGamma, scale=tau2.posterior.scale)
